...
namespace IdentityManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(user1.UserName, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    TempData["Message"] = rolename;
                    TempData["DepartmentId"] = user.DepartmentId;
                    TempData["EmployeeId"] = user.Id;
                    TempData.Keep("Message");
                    TempData.Keep("DepartmentId");
                    TempData.Keep("EmployeeId");
                    return RedirectToAction("UserDashBoard", "Employee");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    IsDeleted = false,
                    PasswordSimple = model.ConfirmPassword,
